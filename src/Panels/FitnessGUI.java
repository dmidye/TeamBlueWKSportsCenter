		...
		acButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
            		...
            		Integer maxVO2 = Integer.parseInt(maxVO2Text.getText());       
		...
		bcButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               try {
            		...
            		Integer BMI = Integer.parseInt(BMIText.getText());
            		...
            		Integer desiredtWeightField = Integer.parseInt(desiredWeightText.getText());
            		...
            		if(dbManager.createNewMemberBCForm(memberID, trainerID, BMI, domForearm, domArm, domThigh, domAbdomen, waistCircumference,
            				...
            				leanWeight, fatWeight, desiredtWeightField)) {
						JOptionPane.showMessageDialog(bodyCompPanel, "Success! Body Composition information entered.");
					} else {
						JOptionPane.showMessageDialog(bodyCompPanel, "Unable to add values. Please make sure valid member and trainer IDs are being entered.");
					}
